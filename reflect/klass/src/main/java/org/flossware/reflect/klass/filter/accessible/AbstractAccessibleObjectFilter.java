 ...
 */
public abstract class AbstractAccessibleObjectFilter<T extends AccessibleObject, V> extends AbstractClassFilter<T, V> implements AccessibleObjectFilter<T, V> {
}
